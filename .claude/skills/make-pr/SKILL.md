...
**STOP. Use AskUserQuestion to ask the user:**

> "Should I create a git worktree for this issue? Worktrees isolate changes in a separate directory, recommended for larger changes."

Options:
1. **Yes, create worktree (Recommended)** — Isolates work in a separate directory
2. **No, work in current directory** — Create branch here, simpler for small changes
...
#### If working in current directory:
