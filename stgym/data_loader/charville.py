...
GROUP_COLS = ["reg_id"]  # sample identification column
POS_COLS = ["X", "Y"]  # spatial coordinates
COLUMNS_TO_DROP = ["CELL_ID", "SIZE"]  # misc. information not relevant to the ML task


class CharvilleDataset(AbstractDataset):
    @property
    def raw_file_names(self):
        return [RAW_FILE_NAME]

    def process_data(self):
        # from: ~/Downloads/Codex数据集-2025.3.26/dataset5/Charville_all_merged_data.csv
