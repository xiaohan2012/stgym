...
LABEL_COL = "Level2"  # ground truth label column (cell type)
GROUP_COLS = ["Patient"]  # sample identification column
POS_COLS = ["UMAP1", "UMAP2"]  # spatial coordinates
COLUMNS_TO_DROP = ["Barcode", "BC"]  # misc. information not relevant to the ML task


class ColorectalCancerDataset(AbstractDataset):
    @property
    def raw_file_names(self):
        return [RAW_FILE_NAME]

    def process_data(self):
        # from: ~/Downloads/codex_dataset_2025.7.20/5/Zenodo_15042463.csv
